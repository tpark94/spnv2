'''
Copied and modified from official PyTorch implementation (torchvision v0.11.0)
to allow building with GN for phi > 4

https://pytorch.org/vision/0.11/_modules/torchvision/models/efficientnet.html#efficientnet_b2
'''
import copy
import math
import torch
...
__all__ = ["MBConv", "efficientnet_b0", "efficientnet_b1", "efficientnet_b2", "efficientnet_b3",
